...
\include{chapters/intro}			% فصل اول: مقدمه
\include{chapters/latexIntro}		% فصل دوم: آشنایی مقدماتی با لاتک
...
\include{appendices/appendix1}		% پیوست اول: مدیریت مراجع در لاتک
\include{appendices/appendix2}

%\baselineskip=.75cm
\onehalfspacing
\include{dicts/dicfa2en}
\include{dicts/dicen2fa}
\printindex
