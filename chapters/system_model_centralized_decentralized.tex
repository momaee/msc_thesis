\chapter{اختصاص منابع پردازشی در شبکه اینترنت اشیاء}\label{chap:system_model_centralized_decentralized}
  \thispagestyle{empty}
  \section{مقدمه}
...
\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/optimization_value}}
	\caption{مقدار بهینه برای چهار روش مختلف با ثابت بودن تعداد وظیفه‌هه دربرابر تعداد کل گره‌های شبکه}
	\label{fig:optimization_value}
\end{figure}

\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/time_of_convergence}}
	\caption{مدت زمان آماده شدن جواب نهایی در چهار روش مختلف با فرض ثابت بودن وظیفه‌ها دربرابر تعداد کل گره‌های شبکه}
	\label{fig:time_of_convergence}
\end{figure}

\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/error_convergence_dist_decent}}
	\caption{نحوه‌ی همگرا شدن مقدار خطا در دو روش توزیع‌شده و غیرمتمرکز}
	\label{fig:error_convergence_dist_decent}
\end{figure}


\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/distributed_decent_converge_local_vars}}
	\caption{نحوه‌ی همگرا شدن اندازه‌ی متغیر اصلی مسئله در دو روش توزیع‌شده و غیرمتمرکز}
	\label{fig:distributed_decent_converge_local_vars}
\end{figure}

\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/decentralized_lagrangian_coeffs}}
	\caption{نحوه‌ی همگرا شدن ضرایب لاگرانژین در دو گره در روش غیرمتمرکز}
	\label{fig:decentralized_lagrangian_coeffs}
\end{figure}

\begin{figure}[h]
	\centerline{\includegraphics[width=12cm]{graphics/distributed/distributed_local_vars}}
	\caption{نحوه‌ی همگرا شدن متغیر محلی در دو گره در روش توزیع‌شده}
	\label{fig:distributed_local_vars}
\end{figure}
